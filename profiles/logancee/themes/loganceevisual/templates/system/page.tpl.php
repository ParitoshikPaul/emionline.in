...
<div
  class="<?php print $wrapper_classes; ?>">
  ...
  <div
    class="<?php $page_version == 'boxed' ? print 'box-wrapper' : 'page-wrapper'; ?>">
    <div
                ...
                <div class="header-top-inner">
                  <div class="row">
                    <div class="hidden-xs col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <div
                        class="welcome-user hidden-xs"><?php print t("Hello guys ! Welcome to EMI Online Store !"); ?></div>
                    </div>
          ...
          <div class="header-menu sb-header-menu">
            ...
            <div class="sidebar-footer">
              ...
              <div class="sidebar-footer-content visible-lg">
                <?php print t("© By EMI Online. All Rights Reserved"); ?>
              </div>
            </div>
          </div>
        </header>
              ...
              <div class="footer-copyright">
                <div class="row">
                  <div
                    ...
                    <?php print t("© 2015 <a href=\"//typostores.com\">EMI Online</a>. All Rights
                  Reserved."); ?>
                  </div>
                </div>
              </div>
                          ...
                          <div class="row">
                            <div
                              ...
                              <?php print t("<div class=\"copyright04\">© 2015 <strong><a
                                  style=\"color: #000;\"
                                  href=\"//www.typostores.com\">EMI Online</a></strong>.
                              All Rights Reserved.
                            </div>"); ?>
                            </div>
                            <div
                              class="add04 hidden-xs hidden-sm hidden-md col-xs-6 col-sm-6 col-md-6 col-lg-6">
                              <?php print t("<div class=\"address-footer\">+91 7701806867<span
                                class=\"space\">|</span> EMI Online,
                              New Delhi, India<span class=\"space\">|</span>support@emionline.com
                            </div>"); ?>
                            </div>
                            <div
